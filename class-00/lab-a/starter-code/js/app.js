...
function displayPics(){
  ...
  // The reason that the 'let' on line 33 caused an error, is because rando is defined locally within the displaypics function, and therefore, the console log that was outside of displayPics could not identify the variable 'rando'.
  console.log(viewed);
